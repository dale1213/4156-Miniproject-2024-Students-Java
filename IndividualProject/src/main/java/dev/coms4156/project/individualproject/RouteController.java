...
public class RouteController {
  ...
  public ResponseEntity<?> isCourseFull(
    ...
    try {
      ...
      if (doesCourseExists) {
        ...
        Map<String, Boolean> jsonResponseConverter = new HashMap<>();
  ...
  /**
   * Attempts to add student count to the specified course.
   * This method handles PATCH requests to add students to a course identified by department code
   * and course code. If the course exists, the number of students enrolled in the course is
   * set to the provided count.
   *
   * @param deptCode                    the code of the department containing the course
   * @param courseCode                  the code of the course to add students to
   * @param count                       the number of students to add to the course
   * 
  ...
  /**
   * Attempts to change the location of the specified course.
   * This method handles PATCH requests to change the location of a course identified by department
   * code and course code. If the course exists, its location is updated to the provided location.
   *
   * @param deptCode                    the code of the department containing the course
